...
export interface Props {
  ...
  layout?: {
    variation?: "Simple" | "With border" | "Color reverse" | "Card style";
...
export default function Benefits(
  ...
  const listOfBenefits = benefits.map((benefit, index) => {
    ...
    // New card style layout similar to the image
    if (layout?.variation === "Card style") {
      return (
        <div class="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-[0_0_10px_0_rgba(0,0,0,0.1)]">
          <div class="mb-4">
            <Icon
              id={benefit.icon}
  ...
  return (
    <>
      {/* Card style layout similar to the image */}
      {layout?.variation === "Card style" && (
        <div class="w-full container flex flex-col px-4 py-8 gap-8 lg:gap-10 lg:py-10 lg:px-40">
          <Header
            title={title}
