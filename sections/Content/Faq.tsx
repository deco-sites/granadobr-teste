...
function Question({ question, answer }: Question) {
  return (
    <details class="collapse collapse-arrow join-item border-t border-green-800">
      <summary class="collapse-title text-lg text-green-800 font-medium">
        {question}
      </summary>
      <div
        class="collapse-content font-matria"
